...
public class MongoHouseService {
     ...
     * 查询房子物理位置（地图）数据
     *
     * @param lng  {@link Float}
     * @param lat  {@link Float}
     * @param zoom {@link Integer}
     * @return {@link MapHouseDataResult}
     * @author Kang Yong
     * @date 2022/5/11
     */
    public MapHouseDataResult queryHouseData(Float lng, Float lat, Integer zoom) {
        double distance = BAIDU_ZOOM.get(zoom) * 1.5 / 111.12; // 1.5倍举例范围，根据实际需求调整
        ...
        for (MongoHouse mongoHouse : mongoHouseList) {
